...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 26, 2022 at 02:21 AM
...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  `phoneNumber` varchar(14) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `client` (`id`, `firstName`, `lastName`, `emailAddress`, `phoneNumber`, `birthday`, `streetAddress`, `city`, `province`, `postalCode`) VALUES
...
(1, 'Admin', 'Admin', 'admin@admin.com', '$2y$10$jzoK30xlN1uGQeYEwaGItOgdWfvG4rMYW2gTuFsvo5REGN3tSPmTq');
COMMIT;
